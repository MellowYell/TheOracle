...
SetQuality = 0xA4  # Data: 0x31 - 0x35. APK always sets 0x33 for MX06
...
def notification_handler(sender, data):
    ...
    if data[2] == GetDevState:
        ...
        # In any case, I think the low battery flag is the only one the MX06 uses.
...
parser = argparse.ArgumentParser(
    description="Prints a given image to a MX06 thermal printer.")
...
parser.add_argument("--scale-feed",
                    ...
                    action="store_true")
contrast_args = parser.add_mutually_exclusive_group(required=True)
